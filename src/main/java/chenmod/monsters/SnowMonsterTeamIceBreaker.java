...
public class SnowMonsterTeamIceBreaker extends AbstractMonster{
    public static final String ID = ChenMod.makeID(SnowMonsterTeamIceBreaker.class.getSimpleName());
    private static final MonsterStrings monsterStrings = CardCrawlGame.languagePack.getMonsterStrings(ID);

    private static final String ATLAS_PATH = "chenmod/images/monsters/animation/SnowMonsterTeamIceBreaker/enemy_1069_icebrk.atlas";
    private static final String JSON_PATH = "chenmod/images/monsters/animation/SnowMonsterTeamIceBreaker/enemy_1069_icebrk.json";
    ...
    public SnowMonsterTeamIceBreaker(float offsetX, float offsetY) {
        ...
        if(AbstractDungeon.ascensionLevel >= 3){
            this.damage.add(new DamageInfo(this, STRONGTH_ATTACK_DAMAGE + 2));
            this.damage.add(new DamageInfo(this, ATTACK_DAMAGE + 2 ));
        }else{
            this.damage.add(new DamageInfo(this, STRONGTH_ATTACK_DAMAGE ));
