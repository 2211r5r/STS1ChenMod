...
public class FranticZombieSoldier extends AbstractMonster{
    public static final String ID = ChenMod.makeID(FranticZombieSoldier.class.getSimpleName());
    private static final MonsterStrings monsterStrings = CardCrawlGame.languagePack.getMonsterStrings(ID);

    private static final String ATLAS_PATH = "chenmod/images/monsters/animation/FranticZombieSoldier/enemy_1062_rager_2.atlas";
    private static final String JSON_PATH = "chenmod/images/monsters/animation/FranticZombieSoldier/enemy_1062_rager_2.json";
    ...
    // --- 角色基础属性 ---
    private static final int MAX_HP = 110;
    ...
    public FranticZombieSoldier(float offsetX, float offsetY) {
