...
public class ZombieSoldier extends AbstractMonster {
    public static final String ID = ChenMod.makeID(ZombieSoldier.class.getSimpleName());
    private static final MonsterStrings monsterStrings = CardCrawlGame.languagePack.getMonsterStrings(ID);

    private static final String ATLAS_PATH = "chenmod/images/monsters/animation/ZombieSoldier/enemy_1043_zomsabr.atlas";
    private static final String JSON_PATH = "chenmod/images/monsters/animation/ZombieSoldier/enemy_1043_zomsabr.json";
    ...
    public ZombieSoldier(float offsetX, float offsetY) {
        ...
        if(AbstractDungeon.ascensionLevel >= 7){
            ...
            this.recoverAfterTurn = 7;
        }else{
            this.setHp(MAX_HP);
            this.recoverAfterTurn = 5;
        }
