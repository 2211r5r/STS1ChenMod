...
public class ZombieSarkazCenturion extends AbstractMonster{

    public static final String ID = ChenMod.makeID(ZombieSarkazCenturion.class.getSimpleName());
    private static final MonsterStrings monsterStrings = CardCrawlGame.languagePack.getMonsterStrings(ID);

    private static final String ATLAS_PATH = "chenmod/images/monsters/animation/ZombieSarkazCenturion/enemy_1114_rgrdmn.atlas";
    private static final String JSON_PATH = "chenmod/images/monsters/animation/ZombieSarkazCenturion/enemy_1114_rgrdmn.json";
    ...
    // --- 角色基础属性 ---
    private static final int MAX_HP = 149;
    private static final int ATTACK_DAMAGE = 19;
    private static final int ATTACK_DAMAGE_2 = 12;
    ...
    public ZombieSarkazCenturion(float offsetX, float offsetY) {
        super(monsterStrings.NAME, ID, MAX_HP, 0.0F, 0.0F, 220.0F, 400.0F, null, offsetX, offsetY);
        ...
        switch (this.nextMove){
            ...
            case 2: //  粉尘痛击
                ...
                if (AbstractDungeon.ascensionLevel >= 18) {
                    ...
                    AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(AbstractDungeon.player, this, new DustPower(AbstractDungeon.player, 2), 2));
                }
            ...
            case 3: // 生命汲取
                AbstractDungeon.actionManager.addToBottom(new VampireDamageAction(AbstractDungeon.player, this.damage.get(1), AbstractGameAction.AttackEffect.SLASH_HEAVY));
    ...
    protected void getMove(int i) {
        ...
        if(AbstractDungeon.ascensionLevel >= 18 && lastMove((byte) 2)){
        ...
        switch (move) {
            ...
            case 2://  粉尘打击
                ...
                break;
            case 3:// 生命汲取
                setMove(monsterStrings.MOVES[2],(byte) 3, Intent.ATTACK_BUFF, this.damage.get(1).base);
                break;
            case 4:// 粉尘感染
                setMove(monsterStrings.MOVES[3],(byte)4, Intent.BUFF);
                break;
