...
public class SnowMonsterTeamSoldier extends AbstractMonster{
    public static final String ID = ChenMod.makeID(SnowMonsterTeamSoldier.class.getSimpleName());
    private static final MonsterStrings monsterStrings = CardCrawlGame.languagePack.getMonsterStrings(ID);

    private static final String ATLAS_PATH = "chenmod/images/monsters/animation/SnowMonsterTeamSoldier/enemy_1064_snsbr.atlas";
    private static final String JSON_PATH = "chenmod/images/monsters/animation/SnowMonsterTeamSoldier/enemy_1064_snsbr.json";
    ...
    public SnowMonsterTeamSoldier(float offsetX, float offsetY) {
        ...
        animSpeedMap.put("Run_Loop", 1.0f);
    ...
    private void loadSpine() {
        ...
        stateData38.setMix("Idle", "Run_Loop", 0.1f);
        stateData38.setMix("Run_Loop", "Idle", 0.1f);
    ...
    protected void getMove(int i) {
        ...
        if(defendCounter >= DEFEND_TURN_COUNTER - 1){
            setMove(monsterStrings.MOVES[1], (byte) 2, AbstractMonster.Intent.DEFEND);
        }else{
