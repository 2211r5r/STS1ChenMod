...
public class GuerrillaArtilleryman extends AbstractMonster {

    public static final String ID = ChenMod.makeID(GuerrillaArtilleryman.class.getSimpleName());
    private static final MonsterStrings monsterStrings = CardCrawlGame.languagePack.getMonsterStrings(ID);

    private static final String ATLAS_PATH = "chenmod/images/monsters/animation/GuerrillaArtilleryman/enemy_1082_soticn.atlas";
    private static final String JSON_PATH = "chenmod/images/monsters/animation/GuerrillaArtilleryman/enemy_1082_soticn.json";
    ...
    private static final int ATTACK_DAMAGE_2 = 6;

    public GuerrillaArtilleryman(float offsetX, float offsetY) {
    ...
    protected void getMove(int i) {
        ...
        switch (move) {
            ...
            case 2://  火焰弹
                ...
                break;
            case 3:// 火力压制
                setMove(monsterStrings.MOVES[2],(byte) 3, Intent.ATTACK_DEBUFF, this.damage.get(1).base);
                break;
