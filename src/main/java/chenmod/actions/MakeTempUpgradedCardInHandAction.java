...
public class MakeTempUpgradedCardInHandAction extends AbstractGameAction {
    ...
    public MakeTempUpgradedCardInHandAction(AbstractCard card, boolean isOtherCardInCenter) {
        ...
        this.c = card;
        if (this.c.type != AbstractCard.CardType.CURSE && this.c.type != AbstractCard.CardType.STATUS && this.c.canUpgrade()) {
            this.c.upgrade();
        }
    ...
    public MakeTempUpgradedCardInHandAction(AbstractCard card) {
        this(card, 1);
    }
    ...
    public MakeTempUpgradedCardInHandAction(AbstractCard card, int amount, boolean isOtherCardInCenter) {
        this(card, amount);
        this.isOtherCardInCenter = isOtherCardInCenter;
    }

    public MakeTempUpgradedCardInHandAction(AbstractCard card, boolean isOtherCardInCenter, boolean sameUUID) {
        this(card, 1);
        this.isOtherCardInCenter = isOtherCardInCenter;
