...
public class ConscriptCard extends BaseCard {

    public static final String ID = makeID(ConscriptCard.class.getSimpleName());
    ...
    public void triggerOnExhaust() {
        this.addToBot(new ApplyPowerAction(
                ...
                AbstractDungeon.player,
                new GlazeWallPower(AbstractDungeon.player)
        ));
    }
