...
public class SkillCostUpPower extends BasePower {

    public static final String POWER_ID = ChenMod.makeID(SkillCostUpPower.class.getSimpleName());
    ...
    public SkillCostUpPower(AbstractCreature owner) {
